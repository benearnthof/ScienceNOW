...
with open (str(ARTIFACTS) + "/subset_2020.pickle", "rb") as handle:
    subset_2020 = pickle.load(handle)

with open (str(ARTIFACTS) + "/subset_2021.pickle", "rb") as handle:
    subset_2021 = pickle.load(handle)

with open (str(ARTIFACTS) + "/subset_2022.pickle", "rb") as handle:
    subset_2022 = pickle.load(handle)

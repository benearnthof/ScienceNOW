...
Perhaps the most intuitive Hyperparameter to showcase is the HDBSCAN minimum cluster size, specified as one of the setup parameters and roughly analogous in impact on model performance to the 
